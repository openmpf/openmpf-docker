...
printUsage() {
    echo "Usages:"
    echo "docker-retag-push-images.sh [--push] [--old-registry] --old-tag [--new-registry] --new-tag"
    echo "docker-retag-push-images.sh --push [--old-registry] --old-tag"
    exit 1
}
