...
if json_data["sourceLanguage"] == "python":
    ...
    if os.path.isdir(wheelhouse_dir):
        print "Setting up virtualenv for Python setuptools-based component " + json_data["componentName"]
        ...
        print "Setting up virtualenv for basic Python component " + json_data["componentName"]
